<?php 
    ...
    if (is_post_request()) {
        ...
        if ($result ==- true) {
            $_SESSION['status_message'] = 'Admin updated successfully';
            redirect_to(url_for('/staff/admins/show.php?id=') . h(u($admin['id'])));
        } else {
            $errors = $result;
        }
    } else {
...
<div id="content">
  <div class="actions">
    <a class="action" href="<?php echo url_for('/staff/admins/index.php'); ?>"
